...
@javax.annotation.Generated(value = {"com.epam.cme.mdp3.test.gen.MDInstrumentDefinitionFuture27Decoder"})
...
public class MDInstrumentDefinitionFuture27Decoder
{
        ...
        implements Iterable<NoEventsDecoder>, java.util.Iterator<NoEventsDecoder>
    {
        ...
        private MDInstrumentDefinitionFuture27Decoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        public void wrap(
            final MDInstrumentDefinitionFuture27Decoder parentMessage, final DirectBuffer buffer)
        {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append(lastUpdateTime());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MDSecurityTradingStatus', referencedName='null', description='Identifies the current state of the instrument. In Security Definition message this tag is available in the Instrument Replay feed only ', id=1682, version=0, deprecated=0, encodedLength=0, offset=14, componentTokenCount=15, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        //Token{signal=BEGIN_ENUM, name='SecurityTradingStatus', referencedName='null', description='Identifies the current state of the instrument. In Security Definition message this tag is available in the Instrument Replay feed only ', id=-1, version=0, deprecated=0, encodedLength=1, offset=14, componentTokenCount=13, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='int'}}
        ...
        //Token{signal=ENCODING, name='uInt8', referencedName='null', description='Product complex', id=-1, version=0, deprecated=0, encodedLength=1, offset=18, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        ...
        //Token{signal=ENCODING, name='Symbol', referencedName='null', description='Instrument Name or Symbol ', id=-1, version=0, deprecated=0, encodedLength=20, offset=35, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='String'}}
        ...
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='SettlCurrency', referencedName='null', description='Identifies currency used for settlement, if different from trading currency', id=120, version=0, deprecated=0, encodedLength=0, offset=79, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='Currency'}}
        //Token{signal=ENCODING, name='Currency', referencedName='null', description='Identifies currency used for settlement, if different from trading currency', id=-1, version=0, deprecated=0, encodedLength=3, offset=79, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='Currency'}}
        ...
        //Token{signal=ENCODING, name='CHAR', referencedName='null', description='Matching algorithm ', id=-1, version=0, deprecated=0, encodedLength=1, offset=82, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='char'}}
        ...
        //Token{signal=ENCODING, name='uInt32', referencedName='null', description='The minimum trading volume for a security', id=-1, version=0, deprecated=0, encodedLength=4, offset=83, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='Qty'}}
        ...
        //Token{signal=ENCODING, name='uInt32', referencedName='null', description='The maximum trading volume for a security', id=-1, version=0, deprecated=0, encodedLength=4, offset=87, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='Qty'}}
        builder.append("maxTradeVol=");
        builder.append(maxTradeVol());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MinPriceIncrement', referencedName='null', description='Minimum constant tick for the instrument, sent only if instrument is non-VTT (Variable Tick table) eligible', id=969, version=0, deprecated=0, encodedLength=0, offset=91, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICE', referencedName='null', description='Minimum constant tick for the instrument, sent only if instrument is non-VTT (Variable Tick table) eligible', id=-1, version=0, deprecated=0, encodedLength=8, offset=91, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        builder.append("minPriceIncrement=");
        minPriceIncrement().appendTo(builder);
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='DisplayFactor', referencedName='null', description='Contains the multiplier to convert the CME Globex display price to the conventional price', id=9787, version=0, deprecated=0, encodedLength=0, offset=99, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='float'}}
        //Token{signal=BEGIN_COMPOSITE, name='FLOAT', referencedName='null', description='Contains the multiplier to convert the CME Globex display price to the conventional price', id=-1, version=0, deprecated=0, encodedLength=8, offset=99, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='float'}}
        ...
        //Token{signal=ENCODING, name='uInt8NULL', referencedName='null', description='Price Denominator of Main Fraction', id=-1, version=0, deprecated=0, encodedLength=1, offset=107, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=255, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        ...
        //Token{signal=ENCODING, name='uInt8NULL', referencedName='null', description='Price Denominator of Sub Fraction', id=-1, version=0, deprecated=0, encodedLength=1, offset=108, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=255, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        ...
        //Token{signal=ENCODING, name='uInt8NULL', referencedName='null', description='Number of decimals in fractional display price', id=-1, version=0, deprecated=0, encodedLength=1, offset=109, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=255, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        ...
        //Token{signal=ENCODING, name='UnitOfMeasure', referencedName='null', description='Unit of measure for the products' original contract size. This will be populated for all products listed on CME Globex', id=-1, version=0, deprecated=0, encodedLength=30, offset=110, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='String'}}
        ...
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='UnitOfMeasureQty', referencedName='null', description='This field contains the contract size for each instrument. Used in combination with tag 996-UnitofMeasure', id=1147, version=0, deprecated=0, encodedLength=0, offset=140, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='Qty'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='This field contains the contract size for each instrument. Used in combination with tag 996-UnitofMeasure', id=-1, version=0, deprecated=0, encodedLength=8, offset=140, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Qty'}}
        ...
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='The total open interest for the market at the close of the prior trading session.', id=-1, version=0, deprecated=0, encodedLength=4, offset=157, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        ...
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='The total cleared volume of instrument traded during the prior trading session.', id=-1, version=0, deprecated=0, encodedLength=4, offset=161, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        builder.append("clearedVolume=");
        builder.append(clearedVolume());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='HighLimitPrice', referencedName='null', description='Allowable high limit price for the trading day', id=1149, version=0, deprecated=0, encodedLength=0, offset=165, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='Allowable high limit price for the trading day', id=-1, version=0, deprecated=0, encodedLength=8, offset=165, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MaxPriceVariation', referencedName='null', description='Differential value for price banding.', id=1143, version=0, deprecated=0, encodedLength=0, offset=181, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='Differential value for price banding.', id=-1, version=0, deprecated=0, encodedLength=8, offset=181, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='Indicates the quantity that a contract will decay daily by once the decay start date is reached', id=-1, version=0, deprecated=0, encodedLength=4, offset=189, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='Qty'}}
        builder.append("decayQuantity=");
        builder.append(decayQuantity());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='DecayStartDate', referencedName='null', description='Indicates the date at which a decaying contract will begin to decay', id=5819, version=0, deprecated=0, encodedLength=0, offset=193, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='LocalMktDate'}}
        ...
        builder.append(decayStartDate());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='OriginalContractSize', referencedName='null', description='Fixed contract value assigned to each product', id=5849, version=0, deprecated=0, encodedLength=0, offset=195, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='Qty'}}
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='Fixed contract value assigned to each product', id=-1, version=0, deprecated=0, encodedLength=4, offset=195, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='Qty'}}
        builder.append("originalContractSize=");
        builder.append(originalContractSize());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='ContractMultiplier', referencedName='null', description='Number of deliverable units per instrument, e.g., peak days in maturity month or number of calendar days in maturity month', id=231, version=0, deprecated=0, encodedLength=0, offset=199, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        //Token{signal=ENCODING, name='Int32NULL', referencedName='null', description='Number of deliverable units per instrument, e.g., peak days in maturity month or number of calendar days in maturity month', id=-1, version=0, deprecated=0, encodedLength=4, offset=199, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=2147483647, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        ...
        //Token{signal=ENCODING, name='Int8NULL', referencedName='null', description='The schedule according to which the electricity is delivered in a physical contract, or priced in a financial contract. Specifies whether the contract is defined according to the Easter Peak, Eastern Off-Peak, Western Peak or Western Off-Peak.', id=-1, version=0, deprecated=0, encodedLength=1, offset=204, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=127, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='int'}}
        builder.append("flowScheduleType=");
        builder.append(flowScheduleType());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='MinPriceIncrementAmount', referencedName='null', description='Monetary value equivalent to the minimum price fluctuation', id=1146, version=0, deprecated=0, encodedLength=0, offset=205, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='Price'}}
        //Token{signal=BEGIN_COMPOSITE, name='PRICENULL', referencedName='null', description='Monetary value equivalent to the minimum price fluctuation', id=-1, version=0, deprecated=0, encodedLength=8, offset=205, componentTokenCount=4, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='Price'}}
        ...
        //Token{signal=ENCODING, name='UserDefinedInstrument', referencedName='null', description='User-defined instruments flag', id=-1, version=3, deprecated=0, encodedLength=1, offset=213, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='char'}}
        ...
        //Token{signal=ENCODING, name='LocalMktDate', referencedName='null', description='Indicates session date corresponding to the settlement price in tag 1150-TradingReferencePrice', id=-1, version=6, deprecated=0, encodedLength=2, offset=214, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=UINT16, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=65535, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='LocalMktDate'}}
        ...
        builder.append(']');
        builder.append('|');
        //Token{signal=BEGIN_GROUP, name='NoInstAttrib', referencedName='null', description='Number of repeating InstrAttribType entries', id=870, version=0, deprecated=0, encodedLength=4, offset=-1, componentTokenCount=33, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
