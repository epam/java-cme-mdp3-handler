...
public class MdpChannelBuilder {
    ...
    private MBOChannelListener mboChannelListener;
    ...
    public MdpChannelBuilder usingListener(final MBOChannelListener mboChannelListener) {
        this.mboChannelListener = mboChannelListener;
        return this;
    }
    ...
    public MdpChannel build() {
        try {
            ...
            mdpChannel = new MdpChannelImpl(scheduler, cfg.getChannel(this.channelId), mdpMessageTypes, queueSlotInitBufferSize,
