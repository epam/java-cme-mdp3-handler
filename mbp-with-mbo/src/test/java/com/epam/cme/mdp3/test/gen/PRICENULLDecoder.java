...
@javax.annotation.Generated(value = {"com.epam.cme.mdp3.test.gen.PRICENULLDecoder"})
...
public class PRICENULLDecoder
{
    ...
    {
        builder.append('(');
        //Token{signal=ENCODING, name='mantissa', referencedName='null', description='mantissa', id=-1, version=0, deprecated=0, encodedLength=8, offset=0, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT64, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=9223372036854775807, constValue=null, characterEncoding='UTF-8', epoch='null', timeUnit=null, semanticType='null'}}
