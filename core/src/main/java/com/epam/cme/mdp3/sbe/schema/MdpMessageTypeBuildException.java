...
public class MdpMessageTypeBuildException extends Exception {
    ...
    public MdpMessageTypeBuildException(String message) {
        super(message);
    }

    public MdpMessageTypeBuildException(String message, Throwable cause) {
        super(message, cause);
    }

    public MdpMessageTypeBuildException(Throwable cause) {
        super(cause);
    }
}
