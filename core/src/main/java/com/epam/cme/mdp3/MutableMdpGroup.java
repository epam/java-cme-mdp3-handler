 ...
 */
public interface MutableMdpGroup extends MdpGroup {
    void reset(final SbeBuffer buffer, final SbeGroupType sbeGroupType, final int blockLength, final int numInGroup, final int groupBodyOffset);
}
